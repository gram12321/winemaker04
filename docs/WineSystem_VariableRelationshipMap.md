...
| Storage vessels | Buy Market cask offers | Individually owned fixed-capacity cellar assets; future explicit winery/vineyard effect inputs |
...
- Buy-market previews may simulate implied state/age/features but suppress notifications and prestige events. Storage Vessel purchases create assets and do not alter wine values until a later explicit allocation/effect rule.
...
| Markets | Sell-side grape trading remains separate; Buy Market has Grape Procurement and Storage Vessels adapters |
