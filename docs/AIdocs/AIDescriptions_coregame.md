...
- Sell-side grape buyers remain independent. The Buy Market owns generic persisted offers and lifecycle dispatch; Grape Procurement supplies bulk/seasonal grape offers, while Storage Vessels supplies individual cask offers with fixed capacity. Grape offers retain loyalty, economy/weather pressure, research scaling, expiration/decay, and bounded previews.
...
- Equipment gameplay beyond Storage Vessels, advanced farming methods, broad bottle-market demand simulation, customer taste matching, descriptor-level scoring, severe weather events/actions, and dedicated weather research/achievements.
