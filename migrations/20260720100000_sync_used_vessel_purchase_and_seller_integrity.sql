-- Global listing seller provenance is strict, and a completed asset purchase
-- returns the authoritative financial transaction for client-state sync.

ALTER TABLE storage_vessel_market_listings
  DROP CONSTRAINT IF EXISTS storage_vessel_market_listings_seller_check;
ALTER TABLE storage_vessel_market_listings
  ADD CONSTRAINT storage_vessel_market_listings_seller_check CHECK (
