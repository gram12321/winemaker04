...
import { BASE_SEASONAL_BUYER_COUNT, BULK_BASE_SEASON_LIMIT_KG, BUYER_ECONOMY_LIMIT_MULTIPLIERS, BUYER_ECONOMY_PRICE_MULTIPLIERS, BUYER_ECONOMY_VOLATILITY_AMPLITUDE, BUYER_ECONOMY_VOLATILITY_PRESSURE, BUYER_MARKET_COUNTRY_KEYS, BUYER_SEASON_LIMIT_MULTIPLIERS, BUYER_SEASON_PRICE_MULTIPLIERS, BUYER_SEASON_VOLATILITY_PRESSURE, BUYER_YEAR_LIMIT_CYCLE, BUYER_YEAR_PRICE_CYCLE, COUNTRY_MULTIPLIER_RANGE, LIMIT_SEASON_THEME, MAX_SEASONAL_BUYER_COUNT, PRICE_SEASON_THEME, type BuyerMarketCountryKey } from '@/lib/constants/grapeBuyerMarketConstants';
...
function isCountryKey(country?: string): country is CountryKey {
  return !!country && BUYER_MARKET_COUNTRY_KEYS.includes(country as CountryKey);
}
