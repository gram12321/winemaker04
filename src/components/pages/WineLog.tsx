...
export function WineLog({ currentCompany }: WineLogProps) {
  ...
  const wineLog = useGameStateWithData(getWineLogEntries, []);
        ...
        <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm text-blue-800">
              <strong>Note:</strong> This log shows taste quality and characteristics <strong>at bottling time</strong>. 
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">Average Taste Quality</div>
              </div>
            </div>
          </CardContent>
        </Card>
