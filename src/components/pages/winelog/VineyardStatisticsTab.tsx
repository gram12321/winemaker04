                ...
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg p-3">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <div className={`text-sm font-bold ${getColorClass(analytics.bestWine.wineScore)}`}>
                        {formatPercent(analytics.bestWine.wineScore, 0, true)}
                      </div>
                      <div className="text-xs text-gray-500">{getQualityCategory(analytics.bestWine.wineScore)}</div>
                    </div>
                  </div>
                </div>
              </div>
